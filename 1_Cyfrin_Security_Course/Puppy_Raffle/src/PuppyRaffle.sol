...
// @note Using too old solidity version creating problems for contract.
...
contract PuppyRaffle is ERC721, Ownable {
    ...
    // @note Should be constant to save gas
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        // @note If its an empty array it will still emit events
    ...
    function getActivePlayerIndex(address player) external view returns (uint256) {
        ...
        /* 
        @note Que: What if the player is at index[0]
    ...
    // @audit This isnt used anywhere. This is a dead code you can remove it.
